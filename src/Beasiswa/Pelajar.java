 ...
 * @author USER
 */
public class Pelajar extends InputNilai implements Seleksi{

    public Pelajar(String nama, double tesA, double tesB, double tesC) {
    ...
    public double hitungNilaiTotal() {
       return (0.5 * super.tesA) + (0.2 * super.tesB) + (0.3 * super.tesC);
    }
